...
class ScheduleFlowsDialog(QDialog):
    ...
    def _build_header(self) -> QHBoxLayout:
        ...
        title.setStyleSheet("font-size: 15pt; font-weight: 600; color: #0f172a;")
    ...
    def _build_content(self) -> QSplitter:
        ...
        self.empty_label.setStyleSheet("padding: 32px; color: #64748b; font-size: 10pt;")
    ...
    def _build_details_panel(self) -> QWidget:
        ...
        self.detail_name.setStyleSheet("font-size: 12pt; font-weight: 600; border: none;")
        ...
        history_title.setStyleSheet("font-weight: 600; border: none;")
